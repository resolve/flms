  ...
  describe 'create' do
    describe 'access control' do
      let(:request) do
        ...
        post :create, page_id: page_1.url, block_id: block_1a.id, text_layer: layer, use_route: :flms
      end
    ...
    describe 'functionality' do
      it 'creates a text layer' do
        ...
        post :create, page_id: page_1.url, block_id: block_1a.id, text_layer: new_layer, use_route: :flms
